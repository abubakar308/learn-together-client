...
const Stats = () => {
  ...
  fetchData();
    ...
    return (
      <div className="container mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 my-10 px-4 text-center">
      <div className="bg-background dark:bg-darkBackground p-4 sm:p-6 rounded-lg shadow-lg hover:scale-105 transition-transform">

        <h2 className="text-4xl md:text-5xl font-bold text-primary">{uniqueTutors.length}+</h2>
        <p className="">Experienced Tutors</p>
      </div>
